...
| 3막 | 글자 공방 | 글자 공방 | 자음+모음 합치기(가·나·다) | ✅ 구현(음절 6개, 확장 여지) |
...
| 8막 | 이야기 책 | 별빛 우체국 | 문장 읽기(졸업) | ✅ 구현(문장 6개, 확장 여지) |
...
- **앞으로(콘텐츠 보강)**: 3막 음절(현재 6개: 가·나·다·마·고·모)과 8막 문장(현재 6개)이 얇음 → 표본 확장. 3막은 받침 결합 음절도 후보(`combineTeach`에 3자모 경로 이미 존재).
